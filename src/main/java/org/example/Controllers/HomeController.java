...
public class HomeController {
    ...
    private void initialize() {
        ...
        // Get friends count        
        try {
            List<Integer> friendIds = friendsService.getAllFriends(currentUser.getUserId());
            int friendsCount = 0;
            if (friendIds != null) {
        ...
        try {
            List<Notification> notifications = notiService.getAllNotifications(currentUser.getUserId());
            int notiCount = 0;
