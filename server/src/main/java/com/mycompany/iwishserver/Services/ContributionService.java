...
import com.mycompany.iwishserver.DAO.ContributionDAO;
import com.mycompany.iwishserver.DAO.GiftDAO;
...
public class ContributionService {
    ...
    public boolean addContribution(Contribution contribution, int currentUserId) {
        ...
        try {
            ...
            String currentUserName = userDAO.getUserById(currentUserId).getUserName();
