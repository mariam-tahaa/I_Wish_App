...
public class FriendRequestsController {
    ...
    private void loadFriendRequests() {
        try {
            ...
            List<FriendRequest> requests = service.getPendingFriendRequests(currentUser.getUserId());
 ...
 @FXML
    ...
    private void acceptRequest(int requestId) {
        if (service.acceptRequest(requestId,currentUser.getUserId())) {
            loadFriendRequests();
        }
    }

    private void declineRequest(int requestId) {
        if (service.declineRequest(requestId,currentUser.getUserId())) {
            loadFriendRequests();
        }
    }
}
